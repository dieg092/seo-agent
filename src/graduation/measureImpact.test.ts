...
// Back up and restore instead of wiping unscoped. (Matches src/tier1/applyTier1.test.ts.)
...
// ImpactMeasurement and GraduationRecord are new, phase-6-only tables with no real
// production history to protect yet — safe to wipe unscoped.
async function resetCheapTables() {
